 ...
 ******************************************************************************/
package net.battlenexus.classic.ctf.gamemode.ctf;
...
import net.battlenexus.classic.ctf.events.EventListener.Vector;
...
import net.battlenexus.classic.ctf.gamemode.ctf.stalemate.actions.DropFlags;
import net.battlenexus.classic.ctf.gamemode.ctf.utl.Team;
import net.battlenexus.classic.ctf.gamemode.ctf.utl.Voter;
...
public class CTF extends Gamemode {
	...
	public static final String[] DEFAULT_FLAGS = new String[] {
		"net.battlenexus.classic.ctf.blocks.BlueFlag",
		"net.battlenexus.classic.ctf.blocks.RedFlag",
